...
import { ImageViewProps } from '@/PropTypes/ImageViewProps'
      ...
      <AnimatePresence mode='wait'>
        ...
        >
          <Image
            ...
            height={700}
            priority
            className='w-full h-96 max-h-[550px] min-h-[500px] object-contain group-hover:scale-110 hoverEffect rounded-md' // Image styles
          />
        </motion.div>
      </AnimatePresence>
